...
Example usage:
    python object_detection/dataset_tools/create_all_drones_tf_records.py \
        --raw_data_dir=/home/user/VOCdevkit \
...
flags = tf_app.flags
flags.DEFINE_string('raw_data_dir', '', 'Root directory to raw PASCAL VOC dataset.')
...
def main(_):
  ...
  files_list_file = os.path.join(FLAGS.raw_data_dir, FLAGS.set, '.txt') 
